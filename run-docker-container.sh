...
VOLUMES=("$HOME/nginx-sekm/logs:/var/log/nginx" "$HOME/nginx-sekm/html:/usr/share/nginx/html:ro" "$HOME/nginx-sekm/conf/nginx.conf:/etc/nginx/nginx.conf" "$HOME/nginx-sekm/conf/sites:/etc/nginx/sites" "$HOME/nginx-sekm/conf/ssl:/etc/nginx/ssl")
ENTRYPOINT=""
CMD=""
